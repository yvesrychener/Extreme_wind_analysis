...
We will still estimate the return levels: TODO
```{r}
return_level_100 = list()
return_level_50 = list()
for (i in 1:length(monthly_max)) {
  
}
names(return_level_100) = names(monthly_data)
names(return_level_50) = names(monthly_data)
